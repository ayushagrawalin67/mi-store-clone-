...
const NavOptios = ( {miPhones,redmiPhones,tv,laptop,fitnessAndLifeStyle,home,audio,accessories}) => {
   ...
   useEffect(() => {
    ...
    if(window.location.href.split("/")[3] === "miphones"){
        
        return   setMiPhoneToggle(true)
       }
     if(window.location.href.split("/")[3] === "redmiphones"){
        return   setRedmiPhoneToggle(true)
       }
       if(window.location.href.split("/")[3] === "tv"){
        return   setTvToggle(true)
       }
       if(window.location.href.split("/")[3] === "laptops"){
        return   setLaptopToggle(true)
       }
       if(window.location.href.split("/")[3] === "lifestyle"){
        return  setFitnessToggle(true)
       }
       if(window.location.href.split("/")[3] === "home"){
        return  setHomeToggle(true)
       }
       if(window.location.href.split("/")[3] === "audio"){
        return  setAudioToggle(true)
       }
       
       if(window.location.href.split("/")[3] === "accessories"){
